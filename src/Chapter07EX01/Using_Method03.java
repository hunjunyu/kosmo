...
public class Using_Method03 {
   ...
   static void def() {
    ...
    //Static 메소드 내부에 인스턴스 필드나 메소드는 바로 사용할 수 없다. (객체화 시켜야 사용이 가능)
    //
    // 
	...
	public static void main(String[] args) {
		// main 메소드도 method 이다.
		int a;  // 지역변수 <== Stack 에 저장, Stack 영역을 강제 초기화가 안됌.
		...
		// main도 메소드 내부의 메소드 선언은 불가, 클래스 블락에서 메소드 선언가능.
		/*  오류발생
		void abc () {
		...
		*/
		...
		// 필드명, 메소드명 앞에 static 키가 적용되있으면 객체 생성없이 호출 
		// static 메소드 내에서는 인스턴스 필드나 인스턴스 메소드를 사용 할 수 없다.
