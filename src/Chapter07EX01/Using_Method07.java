...
public class Using_Method07 {
	...
	//위의 메소드와 시그니쳐가 같다. : 메소드명, 매개 변수 타입, 매개변수 갯수
	//static void print (int c) {
		//매개변수의 타입과 갯수가 같아서 오류 발생 : 시그니쳐가 같다 : 메소드 명, 매개변수의 타입, 갯수
	
	
	
	
	static void print (double a) {
		System.out.println(a + " : 값이 입력 되었습니다. - 매개변수: 실수 1");
	...
	static void print (int a, int b) {
		System.out.println( a+ " , " + b + " : 값이 입력 되었습니다. - 매개변수 : 정수1 성수1" );
	}
	static void print (int a, double b) {
		System.out.println( a+ " , " + b + " : 값이 입력 되었습니다. - 매개변수 : 정수1 실수1");
	}
     /* 위의 메소드와 시그니쳐가 동일함 : 메소드명, 입력매개변수 타입, 개수
	...
	*/
	public static void main(String[] args) {
		...
		//    : 동일한 메소드 이릅에 대해서 시그니쳐가 다른 경우 다른 메소드로 인식한다.
		//       시그니쳐 : 메소드명, 입력 매개 변수 타입, 입력 매개 변수 갯수
