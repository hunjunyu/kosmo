...
public class Using_Arrays_04 {

	public static void main(String[] args) {
		// 배열(Array) : 하나의 [배열] 변수에 여러개의 값을 넣는것.
		// --참조 자료형 : 변수는 Stack에 저장, 값은  Heap에 저장
		//        변수의 Heap 영역의 주소 값이 들어가있다.
		...
		// 2. 방의 갯수를 변경할 수 없다. (정적)
		  ...
		  //   -- 참조자료형일경우 : null <==== 0이 아니고 비어있는상태
		
		// 1. 배열 선언 과 초기화
		int []a = new int[5];
		   //int 배열 변수 ([]) a를 생성
		  //new : Heap 공간에 int 배열방 5개를 생성  Heap의 주소를 a변수에 할당.
		...
		System.out.println("===========for 문을 사용해서 값을 입력, 출력=================");
