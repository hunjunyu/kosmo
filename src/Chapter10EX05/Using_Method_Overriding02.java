...
public class Using_Method_Overriding02 {
	...
	public static void main(String[] args) {
		...
		// 자식의 객체를 생성할때 부모 타입으로 정의 후 부모의 메소드를 호출시 오버라이딩된 메소드 출력됨.
		// 오버라이딩을 사용해서 하나의 타입으로 정의, 배열이나 컬렉션에 저장해서 관리르 쉽게 할 수 있다.
		...
		int[] arr1 = new int[5];     //배열의 방 크기기 지정후 값을 할당.
