...
public class usingscanner {
	...
	public static void main(String[] args) {
		...
		/*
		  - 콘솔을 통해서 값(정수(int),문자열(next)(nextln),소수,실수,문자)을 받아서 처리
		    실수(next.double)
		  - 격체를 임포트해서 사용해야한다. (import java.util.Scanner)
		  - 공백이나 엔터를 사용해서 여러개의 값을 넣을 수 있다.
		 - Scanner sc를 사용후에는 sc.close를 사용해야된다.
		
		 */
      
		Scanner sc = new Scanner (System.in);
	   //(클래스)  //Scanner 클래스로 부터 sc라는 객체를 생성함. (콘솔을 통해서 인풋받음)
	   // ctr + shift + o  : 외부 클래스 자동 import
	    ...
	    System.out.println("변수  b를 출력 : "  + b); //문자열 +enter
