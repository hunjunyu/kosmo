...
public class Using_nonRectangle_Array03 {
	...
	public static void main(String[] args) {
		...
		//1. 방법 1 : 비정방형 배열 선언 후 방 크기를 생성 후 값 할당.
		int [][]arr1 = new int [2][];   //행의 갯수만 지정 , 열의 갯수는 나중에 지정함
		arr1 [0] = new int  [2];  // 0번째의 행의 열의 갯수 2개를 지정
        arr1 [0][0] = 1;
        arr1 [0][1] = 2;
        arr1 [1] = new int [3];  // 1번째 행의 열의 갯수3개를 지정
        arr1 [1][0] = 3;
        arr1 [1][1] = 4;
        arr1 [1][2] = 5;
		...
		System.out.println("===========================================");
		//2. 방법2 : 비정방형 배열 선언 시 값을 할당.
		
		int [] [] arr2 = new int [2][];  //비정방형 배열 선언 : 행의 갯수만 먼저 선언, 열은 선언하지 않음
		arr2 [0] = new int[] {1,2};  //0행의 값을 바로 할당. (주의 : 방크기 지정하면 오류)
		...
		//4. 방법4 : 비정방형 배열 선언 시 값을 할당 (선언과 초기화 분리시 오류 발생)
		int [][] arr5 =  {{1,2},{3,4,5}};
